...
from optimum.onnxruntime.constants import DECODER_MERGED_ONNX_FILE_PATTERN, DECODER_ONNX_FILE_PATTERN, DECODER_WITH_PAST_ONNX_FILE_PATTERN
from optimum.onnxruntime.modeling_ort import ONNX_MODEL_END_DOCSTRING, ORTModel
from optimum.onnxruntime.models.bloom import bloom_convert_to_bloom_cache, bloom_convert_to_standard_cache
from optimum.onnxruntime.utils import MULTI_QUERY_ATTN_MODELS, ONNX_DECODER_NAME, ONNX_DECODER_WITH_PAST_NAME, ONNX_WEIGHTS_NAME
...
class ORTModelForCausalLM(ORTModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        decoder_time = inf_end - inf_start
        postprocessing_time = post_end - post_start
        logging.critical(f"[PROFILE][ORTAMD] model_decoder_forward {decoder_time} {preprocessing_time} {postprocessing_time}")
